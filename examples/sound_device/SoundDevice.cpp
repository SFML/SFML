...
int main()
{
    ...
    if (devices.empty())
    {
        std::cout << "No playback devices available" << std::endl;
        return EXIT_FAILURE;
    }
    ...
    auto automaticStreamRouting = false;
    ...
    {
        std::cout << "Failed to set the playback device" << std::endl;
        return EXIT_FAILURE;
    }
    ...
    static const auto outputDeviceInfo = []
    {
        if (auto device = sf::PlaybackDevice::getDevice(); device)
    ...
    while (true)
    {
        ...
        {
            auto availableDevices = sf::PlaybackDevice::getAvailableDevices();
        ...
        while (true)
        {
            if (selectedDeviceAvailable())
            {
                ...
                std::cout << "Device " << selectedDevice << " available again" << std::endl;
