...
int main()
{
    ...
    auto& boldText                = demoTexts.emplace_back("NotoSerif-Regular.ttf",          "Normal/Bold/Italic");
    auto& italicText              = demoTexts.emplace_back("NotoSerif-Regular.ttf",          "Normal/Bold/Italic");
    auto& zalgoText               = demoTexts.emplace_back("NotoSerif-Regular.ttf",          "Z̴̢̧͕̱͍͖̱̙̲̳͉̘̐̒͜a̴̲̖̖̖͈͉̪͎̜̽̓̀̀̒͌l̸̰͙̳̗͎͙̼͓̭̥͖̾̀̅̏͐̾͊̃͂̾ͅg̷̡̢͚̗͎̰̦͔̰̬͍̖̩̺̞͕̓̃̇ö̴̜̳̼̘̗͖͍̻͎͓̣̮̝̯͉̞́̄̉̀̄͆̈́͛̐̂̾͐̓̄");
    auto& tabText                 = demoTexts.emplace_back("NotoSerif-Regular.ttf",          "Tab: >\t<");
    auto& rainboxText             = demoTexts.emplace_back("NotoSerif-Regular.ttf",          "Rainbow Text!");
    auto& bidiText                = demoTexts.emplace_back("NotoNaskhArabic-Regular.ttf",    "Aligned multi-line\nنص ثنائي الاتجاه باستخدام مكتبة SFML الإصدار " + sfmlVersionString + ".\nالأرقام: 0123456789");
    auto& leftAligned             = demoTexts.emplace_back("NotoNaskhArabic-Regular.ttf",    "Left-Aligned\nText\nنص محاذي");
    auto& centered                = demoTexts.emplace_back("NotoNaskhArabic-Regular.ttf",    "Center-Aligned\nText\nنص محاذي");
    auto& rightAligned            = demoTexts.emplace_back("NotoNaskhArabic-Regular.ttf",    "Right-Aligned\nText\nنص محاذي");
    auto& horizontalStrikethrough = demoTexts.emplace_back("NotoSerif-Regular.ttf",          "Strikethrough");
    auto& horizontalUnderlined    = demoTexts.emplace_back("NotoSerif-Regular.ttf",          "Underlined");
    auto& verticalKorean          = demoTexts.emplace_back("NotoSerifKR-Regular.subset.ttf", "누워서 떡 먹기");
    auto& verticalJapanese        = demoTexts.emplace_back("NotoSerifJP-Regular.subset.ttf", "七転び八起き");
    auto& verticalChinese         = demoTexts.emplace_back("NotoSerifTC-Regular.subset.ttf", "一字值千金");
    auto& topToBottomText         = demoTexts.emplace_back("NotoSerif-Regular.ttf",          "Down Text");
    auto& bottomToTopText         = demoTexts.emplace_back("NotoSerif-Regular.ttf",          "Up Text");
    auto& verticalStrikethrough   = demoTexts.emplace_back("NotoSerif-Regular.ttf",          "Strikethrough");
    auto& verticalUnderlined      = demoTexts.emplace_back("NotoSerif-Regular.ttf",          "Underlined");
    // clang-format on
