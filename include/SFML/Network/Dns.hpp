...
struct MxRecord
{
    std::string   exchange;     //!< Host willing to act as mail exchange
...
///
/// Currently will not return any data on Android.
///
...
struct SrvRecord
{
    std::string   target; //!< The domain name of the target host
...
///
////////////////////////////////////////////////////////////
[[nodiscard]] SFML_NETWORK_API std::vector<std::string> queryTXT(const sf::String& hostname);
} // namespace sf::Dns
