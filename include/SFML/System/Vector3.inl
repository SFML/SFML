...
////////////////////////////////////////////////////////////
template <typename T>
constexpr inline Vector3<T>::Vector3() :
x(0),
y(0),
z(0)
{
...
////////////////////////////////////////////////////////////
template <typename T>
constexpr inline Vector3<T>::Vector3(T X, T Y, T Z) :
x(X),
y(Y),
z(Z)
{
...
template <typename T>
template <typename U>
constexpr inline Vector3<T>::Vector3(const Vector3<U>& vector) :
...
////////////////////////////////////////////////////////////
template <typename T>
constexpr inline Vector3<T> operator -(const Vector3<T>& left)
{
