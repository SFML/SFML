...
{
    return *this >> reinterpret_cast<std::uint8_t&>(data);
}
...
{
    return *this >> reinterpret_cast<std::uint16_t&>(data);
}
...
{
    return *this >> reinterpret_cast<std::uint32_t&>(data);
}
...
{
    return *this >> reinterpret_cast<std::uint64_t&>(data);
}
...
Packet& Packet::operator<<(std::int16_t data)
{
    return *this << static_cast<std::uint16_t>(data);
}
...
Packet& Packet::operator<<(std::int32_t data)
{
    return *this << static_cast<std::uint32_t>(data);
}
...
Packet& Packet::operator<<(std::int64_t data)
{
    return *this << static_cast<std::uint64_t>(data);
}
