...
String getDescription(Keyboard::Scancode code)
{
    switch (code)
    {
        ...
        case sf::Keyboard::Scan::Hyphen:            return "Hyphen (-)";
        case sf::Keyboard::Scan::Equal:             return "Equal (=)";
        case sf::Keyboard::Scan::LBracket:          return "Left Bracket [";
        case sf::Keyboard::Scan::RBracket:          return "Right Bracket ]";
        case sf::Keyboard::Scan::Backslash:         return "Backslash \\";
        case sf::Keyboard::Scan::Semicolon:         return "Semicolon ;";
        case sf::Keyboard::Scan::Apostrophe:        return "Apostrophe '";
        case sf::Keyboard::Scan::Grave:             return "Grave `";
        case sf::Keyboard::Scan::Comma:             return "Comma ,";
        case sf::Keyboard::Scan::Period:            return "Period .";
        case sf::Keyboard::Scan::Slash:             return "Slash /";
