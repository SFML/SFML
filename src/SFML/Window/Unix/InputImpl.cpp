...
namespace
{
    ...
    void buildMap()
    {
        ...
        keycodeMap[sf::Keyboard::Numpad0]   = getKeycode(XK_KP_Insert);
        keycodeMap[sf::Keyboard::Numpad1]   = getKeycode(XK_KP_End);
        keycodeMap[sf::Keyboard::Numpad2]   = getKeycode(XK_KP_Down);
        keycodeMap[sf::Keyboard::Numpad3]   = getKeycode(XK_KP_Page_Down);
        keycodeMap[sf::Keyboard::Numpad4]   = getKeycode(XK_KP_Left);
        keycodeMap[sf::Keyboard::Numpad5]   = getKeycode(XK_KP_Begin);
        keycodeMap[sf::Keyboard::Numpad6]   = getKeycode(XK_KP_Right);
        keycodeMap[sf::Keyboard::Numpad7]   = getKeycode(XK_KP_Home);
        keycodeMap[sf::Keyboard::Numpad8]   = getKeycode(XK_KP_Up);
        keycodeMap[sf::Keyboard::Numpad9]   = getKeycode(XK_KP_Page_Up);
