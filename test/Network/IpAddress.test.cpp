    ...
    SECTION("Construction")
    {
        SECTION("IPv4")
        {
            SECTION("static 'fromString' function")
            {
                ...
                CHECK(!sf::IpAddress::fromString("255.255.255.256"s).has_value());
                CHECK(!sf::IpAddress::fromString("").has_value());
            }
        ...
        SECTION("IPv6")
        {
            SECTION("static 'fromString' function")
            {
                ...
                CHECK(!sf::IpAddress::fromString("1:::1"s).has_value());
                CHECK(!sf::IpAddress::fromString("1:1"s).has_value());
                CHECK(!sf::IpAddress::fromString("1::1::1"s).has_value());
                CHECK(!sf::IpAddress::fromString("ghij:klmn:opqr:stuv::wxzy"s).has_value());
                CHECK(!sf::IpAddress::fromString("").has_value());
            }
